        ...
        for (int i = 0; i < args.length; i = i+2) {
            switch (args[i]) {
                ...
                case "--zk":
                    ...
                    break;
                default:
                    System.out.println("Nepoznat argument: " + args[i]);
            }
        }

        if (putanjaStanice == null) {
            System.out.println("Nije naveden put do datoteke stanica (--zs)");
        }
        if (putanjaVozila == null) {
            System.out.println("Nije naveden put do datoteke vozila (--zps)");
        }
