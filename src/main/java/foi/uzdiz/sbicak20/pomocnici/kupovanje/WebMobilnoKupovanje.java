...
public class WebMobilnoKupovanje implements NacinKupovanjaStrategy {
    ...
    public Karta kupiKartu(String oznakaVlaka, String polaznaStanica, String odredisnaStanica, Date datum) {
        try {
            ...
            double popust = cjenikKarti.getPopustWebMob();
            ...
            return new Karta.KartaBuilder()
                    ...
                    .uvecanje(0)
                    .popust(popust)
                    .popustSuN((danUTjednu == DayOfWeek.SATURDAY || danUTjednu == DayOfWeek.SUNDAY) ? cjenikKarti.getPopustSuN() : 0)
                    .konacnaCijena(konacnaCijena)
                    .nacinKupovanja("Web/mobilno")
